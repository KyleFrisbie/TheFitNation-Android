...
public class GetUserWorkoutInstancesTask extends NetworkTask {
    private static String TAG = GetUserWorkoutInstancesTask.class.getSimpleName();

    public GetUserWorkoutInstancesTask(String authToken, RequestQueue requestQueue) {
     ...
     */
    public void getWorkoutInstance(final WorkoutInstance workoutInstance, final WorkoutInstancePostCallback callback) {
        ...
        final StringRequest getWorkoutInstance = new StringRequest(Request.Method.GET, url,
        ...
        getWorkoutInstance.setRetryPolicy(new DefaultRetryPolicy(10000, 1, 1));

        mRequestQueue.add(getWorkoutInstance);
    }
}
