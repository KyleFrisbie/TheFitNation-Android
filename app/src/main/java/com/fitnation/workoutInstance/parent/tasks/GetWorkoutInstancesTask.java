...
public class GetWorkoutInstancesTask extends NetworkTask {
    private static String TAG = GetWorkoutInstancesTask.class.getSimpleName();

    public GetWorkoutInstancesTask(String authToken, RequestQueue requestQueue) {
