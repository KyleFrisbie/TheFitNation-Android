...
public class GetWorkoutTemplateTask extends NetworkTask{
    private static final String TAG = GetWorkoutTemplateTask.class.getSimpleName();

    public GetWorkoutTemplateTask(String authToken, RequestQueue requestQueue) {
